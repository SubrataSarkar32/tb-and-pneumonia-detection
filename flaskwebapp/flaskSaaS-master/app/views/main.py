...
def upload_file():
   if request.method == 'POST':
      ...
      if f and allowed_file(f.filename):
          ...
          json_file = open('/home/subrata/Desktop/subratasarkar32/tb-and-pneumonia-detection-master/flaskwebapp/flaskSaaS-master/app/views/model_4.json', 'r')
          ...
          model.load_weights("/home/subrata/Desktop/subratasarkar32/tb-and-pneumonia-detection-master/flaskwebapp/flaskSaaS-master/app/views/model_4.h5")
